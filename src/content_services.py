...
<section class="band">
  <div class="wrap wrap--narrow">
    ...
    <p>Dial <code>*#06#</code>. If an <strong>EID</strong> appears under the IMEI, it does. Broadly:</p>
    <div class="tbl-wrap">
      <table>
        <thead><tr><th>Phone</th><th>eSIM</th><th>Note</th></tr></thead>
        <tbody>
          <tr><td><b>iPhone XS, XR and newer</b></td><td><span class="yes">Yes</span></td><td>Not on iPhones bought in mainland China</td></tr>
          <tr><td><b>Google Pixel 3 and newer</b></td><td><span class="yes">Yes</span></td><td>Pixel 3 needs a carrier-unlocked model</td></tr>
          <tr><td><b>Samsung S20 and newer</b></td><td><span class="yes">Yes</span></td><td>Some Indian variants shipped without it, check the EID</td></tr>
          <tr><td><b>OnePlus 11 and newer</b></td><td><span class="yes">Yes</span></td><td>Region dependent</td></tr>
          <tr><td><b>Most budget Android</b></td><td><span class="no">No</span></td><td>A physical local SIM is the answer</td></tr>
        </tbody>
      </table>
    </div>
    <div class="note">
