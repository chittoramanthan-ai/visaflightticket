...
VISAS = [
 ...
 'If your passport qualifies for an ETA, use it. About AUD 20 against AUD 190 for a visitor visa.'],
 ...
 ('Health examination', 'AUD$300 to AUD$500', 'Only when requested')],
        steps=[('Check whether an ETA covers you', 'If your passport qualifies, it costs about AUD 20 and takes minutes. Do not pay for a subclass 600 you do not need.'),
