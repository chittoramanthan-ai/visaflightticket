...
dict(
    ...
    status="visa_free", status_note="Visa free on conditions, otherwise e-visa",
...
# ============================================================== Central Asia
dict(
    slug="kazakhstan-visa-for-indians",
    official_src=('Ministry of Foreign Affairs, Kazakhstan', 'https://www.gov.kz/memleket/entities/mfa'),
    label="Kazakhstan", short="Kazakhstan",
    status="visa_free", status_note="Visa free for short tourist stays",
    h1="Kazakhstan entry rules for Indian passport holders",
    title="Kazakhstan for Indians 2026 | Visa Free Entry and Rules",
    desc="Kazakhstan admits Indian passport holders without a visa for short tourist stays. What immigration and airlines actually ask for, and the registration step people miss.",
    route=("DEL", "ALA"),
    blurb="Kazakhstan is one of the easiest countries in the region for an Indian passport: short tourist "
          "visits need no visa applied for in advance. Almaty is under four hours from Delhi, which makes it "
          "one of the shortest genuinely foreign trips available.",
    requirements=[
        "<strong>Passport valid six months</strong> beyond arrival, with blank pages.",
        "<strong>Proof of onward or return travel.</strong> Airlines ask for this at check-in on a one-way booking, visa free or not.",
        "<strong>Accommodation details</strong> for the stay.",
        "<strong>Funds for the trip</strong>, occasionally asked about at the border.",
    ],
    official="The Kazakh Ministry of Foreign Affairs publishes the current entry rules. Confirm the allowance there before booking a longer trip, because the arrangement has been extended and revised more than once.",
    traps=[
        ("Assuming visa free means no documents",
         "Two different things. You skip the visa application. You still face an airline agent who wants to see how you are leaving, and an officer who may ask where you are staying."),
        ("Missing the registration step",
         "Stays beyond the short visa-free window require registration with the migration police. Hotels usually handle it. Private stays become your problem, sometimes discovered on departure."),
        ("Booking a one-way flight",
         "The most common reason to be denied boarding to a visa free country. The airline carries the cost if you are refused entry, so it asks first."),
    ],
    steps=[
        ("Check the current allowance", "On the official ministry site, not a listicle. This has changed before."),
        ("Confirm six months passport validity", "Counted from arrival, not from booking."),
        ("Book accommodation for the stay", "It also settles the registration question."),
        ("Sort proof of onward travel", "A held reservation with a live PNR satisfies the airline."),
        ("Carry it all on paper as well as your phone", "Check-in desks in India are where the questions happen."),
    ],
    fees=[("Tourist visa", "Not required", "Short tourist stays are visa free for Indian passport holders"),
          ("Migration registration", "Free", "Handled by your hotel where required")],
    tips=[
        "Almaty and Astana are very different trips. Almaty has the mountains and the food; Astana is the built-from-nothing capital. Pick one rather than splitting a short visit.",
        "Shymbulak is forty minutes from central Almaty and worth a day even outside ski season. The cable car runs year round.",
        "Kaspi QR is how everyone pays. Cards work in the cities, but carry some tenge for taxis and markets.",
        "The Green Bazaar in Almaty is the one worth going to. Go hungry and before noon.",
    ],
    faqs=[
        ("Is Kazakhstan visa free for Indians?",
         "<p>Yes, for short tourist stays. Check the current allowance on the Kazakh Ministry of Foreign Affairs site before booking, because the arrangement has been revised more than once.</p>"),
        ("Do I still need a return ticket?",
         "<p>Yes, in practice. Visa free governs whether the country admits you. It has no effect on whether an airline boards you, and airlines ask one-way travellers for proof of onward travel.</p>"),
        ("Do I need to register with the police?",
         "<p>For stays beyond the visa-free window, yes. Hotels normally handle it. If you are staying privately, it becomes your responsibility and it is sometimes checked on departure.</p>"),
    ]),

# =================================================================== Caucasus
dict(
    slug="georgia-visa-for-indians",
    official_src=('e-Visa portal, Government of Georgia', 'https://www.evisa.gov.ge/'),
    label="Georgia", short="Georgia",
    status="visa_free", status_note="Visa free if you hold a valid US, UK, Schengen or GCC visa, otherwise e-visa",
    h1="Georgia visa rules for Indian passport holders",
    title="Georgia for Indians 2026 | Visa Free Conditions and e-Visa",
    desc="Georgia admits Indians visa free if they already hold a valid US, UK, Schengen or GCC visa or residence permit. Everyone else applies for an e-visa. The conditions, the traps and what airlines check.",
    route=("DEL", "TBS"),
    blurb="Georgia is the clearest example of a conditional visa waiver. If you already hold a valid visa or "
          "residence permit from a major economy, you walk in. If you do not, you apply for an e-visa online. "
          "Which side of that line you are on decides your whole trip.",
    requirements=[
        "<strong>Either</strong> a valid US, UK, Schengen, GCC, Japanese or Australian visa or residence permit, <strong>or</strong> an approved Georgian e-visa.",
        "<strong>Passport valid six months</strong> beyond your intended stay.",
        "<strong>Proof of onward travel</strong>, checked at the gate more often than at the border.",
        "<strong>Accommodation and funds</strong> for the length of stay.",
    ],
    official="Georgia's official e-visa portal lists both the waiver conditions and the application. The qualifying-visa list changes, so read it there rather than relying on a forum post.",
    traps=[
        ("Assuming the qualifying visa can be expired",
         "It must be valid. A US visa that ran out last year does not qualify you, and this is checked at boarding."),
        ("A single-entry qualifying visa already used",
         "Rules on this differ by nationality and change. If your qualifying visa is single entry and spent, apply for the e-visa instead of arguing at a check-in desk."),
        ("Leaving the e-visa to the last week",
         "Processing is usually quick but not instant, and a rejected application leaves no time to correct it."),
        ("Arriving one way",
         "Airlines refuse boarding for this regardless of which route you are entering on."),
    ],
    steps=[
        ("Work out which route applies to you", "Qualifying visa in hand, or e-visa. This decides everything else."),
        ("If you qualify, carry the proof", "The physical visa or residence permit, not a photo of it."),
        ("If not, apply on evisa.gov.ge", "The official portal. Agent sites charge to type the same form."),
        ("Book accommodation for the full stay", "Asked for on the e-visa form and sometimes at the border."),
        ("Sort proof of onward travel", "A held reservation with a live PNR satisfies the airline."),
    ],
    fees=[("Visa free entry", "Free", "If you hold a qualifying visa or residence permit"),
          ("e-Visa", "Around USD 20 to 25", "Plus any card fee, paid on the official portal"),
          ("Agent markup", "Avoidable", "The official portal is not hard to use")],
    tips=[
        "Tbilisi to Kazbegi is a three-hour drive and the best single day trip in the country. Leave early; the light on the Gergeti church is gone by mid afternoon.",
        "Georgian wine is not an add-on to the trip. Qvevri wine has been made here for eight thousand years, and a Kakheti tasting is worth a full day.",
        "Marshrutka minibuses go everywhere and cost almost nothing, but they leave when full rather than on a timetable.",
        "Prices are quoted in lari and cards are widely accepted in Tbilisi and Batumi. Carry cash for the mountains.",
    ],
    faqs=[
        ("Is Georgia visa free for Indians?",
         "<p>Conditionally. If you hold a valid US, UK, Schengen, GCC, Japanese or Australian visa or residence permit, you enter without a Georgian visa. Otherwise you apply for an e-visa online. Check the current qualifying list on evisa.gov.ge.</p>"),
        ("Does an expired US visa count?",
         "<p>No. The qualifying visa must be valid at the time you travel, and airlines check it at boarding.</p>"),
        ("How long does the e-visa take?",
         "<p>Usually a few working days. Apply at least two weeks out so a query or a correction does not cost you the trip.</p>"),
        ("Do I need a return ticket?",
         "<p>Yes in practice. Airlines ask one-way travellers for proof of onward travel because they carry the cost of a refused entry.</p>"),
    ]),

# ==================================================================== Russia
dict(
    slug="russia-evisa-for-indians",
    official_src=('Unified e-Visa portal, Russian Federation', 'https://evisa.kdmid.ru/'),
    label="Russia", short="Russia",
    status="evisa", status_note="Unified e-visa, applied for online before travel",
    h1="Russia e-visa for Indian passport holders",
    title="Russia e-Visa for Indians 2026 | Cost, Processing, Documents",
    desc="Indians travel to Russia on a unified e-visa applied for online. What the application asks for, how long it takes, and the entry points where it is and is not accepted.",
    route=("DEL", "SVO"),
    blurb="Russia's unified e-visa replaced a paperwork-heavy process with an online form, which is a genuine "
          "improvement. It is still a visa: applied for in advance, tied to specific entry points, and refused "
          "if the details do not match your passport exactly.",
    requirements=[
        "<strong>Approved unified e-visa</strong>, printed and carried.",
        "<strong>Passport valid six months</strong> beyond arrival.",
        "<strong>Medical insurance</strong> valid for the stay and accepted in Russia.",
        "<strong>Proof of onward travel</strong> and accommodation details.",
    ],
    official="The Russian Ministry of Foreign Affairs runs the unified e-visa portal. Apply only there: intermediary sites charge a markup for the same form and cannot speed anything up.",
    traps=[
        ("Entering through a checkpoint the e-visa does not cover",
         "The unified e-visa is valid only at listed entry points. Arriving at one that is not on the list means refusal, and this catches people on land borders in particular."),
        ("A photograph that fails the specification",
         "The commonest rejection. Follow the portal's stated size and background rules exactly."),
        ("Applying too late",
         "Processing takes several days and there is no expedited route. Apply well ahead."),
        ("Name spelled differently to the passport",
         "Transliteration differences get applications refused. Copy the machine-readable line character for character."),
    ],
    steps=[
        ("Check your entry point is covered", "The unified e-visa works only at listed checkpoints."),
        ("Apply on evisa.kdmid.ru", "The official portal. Have your passport scan and photo ready."),
        ("Buy medical insurance for the stay", "Required, and checked."),
        ("Book accommodation and onward travel", "Both asked for on the form."),
        ("Print the approval", "Carry it on paper. Do not rely on a phone at a land border."),
    ],
    fees=[("Unified e-visa", "Around USD 52", "Paid online, non-refundable if refused"),
          ("Medical insurance", "Varies", "Required for the length of stay"),
          ("Agent markup", "Avoidable", "The official portal takes the same application")],
    tips=[
        "Moscow and St Petersburg are a four-hour Sapsan train apart. Book that rather than flying: it is faster door to door and considerably cheaper.",
        "The Moscow metro is worth an hour of its own. Komsomolskaya and Mayakovskaya in particular are closer to museums than stations.",
        "Card acceptance for foreign-issued cards is unreliable. Plan to carry cash and change it on arrival.",
        "Download offline maps before you fly. Some mapping and transport apps behave unpredictably on foreign SIMs.",
    ],
    faqs=[
        ("Can Indians get a Russian e-visa?",
         "<p>Yes. The unified e-visa is applied for online and covers short tourist, business and humanitarian visits. It is valid only at listed entry checkpoints, so confirm yours before booking.</p>"),
        ("How long does it take?",
         "<p>Several working days. There is no expedited option, so apply at least three weeks before travel.</p>"),
        ("Do I need insurance?",
         "<p>Yes. Medical insurance valid for the stay is a condition of the e-visa and is checked.</p>"),
        ("Is the fee refunded if I am refused?",
         "<p>No. The e-visa fee is non-refundable, which is why the photo and name details are worth getting right first time.</p>"),
    ]),

# ============================================================== South Africa
dict(
    slug="south-africa-visa-for-indians",
    official_src=('Department of Home Affairs, South Africa', 'https://www.dha.gov.za/'),
    label="South Africa", short="South Africa",
    status="evisa", status_note="e-visa for Indian passport holders, applied for online",
    h1="South Africa visa for Indian passport holders",
    title="South Africa e-Visa for Indians 2026 | Cost and Documents",
    desc="Indians need a visa for South Africa, available online as an e-visa. What the application asks for, the financial evidence that decides most cases, and the child-documentation rule that catches families.",
    route=("BOM", "JNB"),
    blurb="South Africa runs an e-visa for Indian passport holders. The form is straightforward; the "
          "decision usually turns on whether your financial evidence and your itinerary tell the same story. "
          "Families should read the child-documentation rule before booking anything.",
    requirements=[
        "<strong>Approved e-visa</strong> before travel.",
        "<strong>Passport valid 30 days</strong> beyond your intended departure, with two blank pages.",
        "<strong>Bank statements</strong> covering recent months, showing funds for the trip.",
        "<strong>Return flight booking</strong> and accommodation for the stay.",
        "<strong>Yellow fever certificate</strong> if arriving from or transiting a listed country.",
    ],
    official="South Africa's Department of Home Affairs runs the e-visa system and publishes the current document list. Read it there, because the requirements for minors differ from those for adults.",
    traps=[
        ("Travelling with children without the extra documents",
         "South Africa asks for an unabridged birth certificate for minors, and consent from an absent parent. This is enforced and it strands families at check-in."),
        ("Thin financial evidence",
         "The most common refusal ground. Show a balance that plausibly funds the trip you have described, and be ready to explain any large recent deposit."),
        ("Two blank pages, not one",
         "A full passport gets you refused at the gate regardless of a valid visa."),
        ("Ignoring the yellow fever rule on transits",
         "It applies if you have merely transited a listed country, not only if you started there."),
    ],
    steps=[
        ("Apply on the official e-visa portal", "Not through an agent site charging a markup."),
        ("Assemble the financial evidence first", "It is what the decision usually turns on."),
        ("If travelling with minors, get the birth certificate", "Unabridged, plus consent where a parent is absent."),
        ("Book a return flight and accommodation", "Both are asked for."),
        ("Check the yellow fever requirement for your route", "Transits count."),
    ],
    fees=[("e-Visa, single entry", "Around ZAR 425", "Roughly USD 23, varies with the rand"),
          ("Yellow fever certificate", "Varies", "Only if your route requires it"),
          ("Agent markup", "Avoidable", "The official portal takes the same application")],
    tips=[
        "Cape Town and Johannesburg are a two-hour flight apart and completely different trips. Two weeks does both comfortably; one week does not.",
        "The Cape Peninsula drive is the single best day out. Start early, go anticlockwise, and you will beat the Chapman's Peak traffic.",
        "Kruger self-drive is genuinely doable and far cheaper than a lodge package. Book a rest camp months ahead.",
        "Load a local eSIM before you land. Navigation matters here more than in most places and roaming charges add up fast.",
    ],
    faqs=[
        ("Do Indians need a visa for South Africa?",
         "<p>Yes. An e-visa is available online for Indian passport holders and should be applied for well before travel.</p>"),
        ("What usually causes a refusal?",
         "<p>Financial evidence that does not support the trip described, or an itinerary that does not match the stated purpose. Both are avoidable.</p>"),
        ("What is the rule about children?",
         "<p>South Africa requires an unabridged birth certificate for minors, and consent from any parent not travelling. It is enforced at check-in, not just at the border.</p>"),
        ("How long is the e-visa valid?",
         "<p>Typically up to 90 days from issue for a stay of up to 90 days, but confirm the dates printed on your own approval.</p>"),
    ]),

# ================================================================== Morocco
dict(
    slug="morocco-evisa-for-indians",
    official_src=('Ministry of Foreign Affairs, Kingdom of Morocco', 'https://www.acces-maroc.ma/'),
    label="Morocco", short="Morocco",
    status="evisa", status_note="e-visa online, or visa free with a valid Schengen or US visa",
    h1="Morocco visa for Indian passport holders",
    title="Morocco e-Visa for Indians 2026 | Cost, Conditions, Documents",
    desc="Indians can enter Morocco on an e-visa, or without one if they hold a valid Schengen or US visa and meet the conditions. Which route applies, and what airlines check at the gate.",
    route=("DEL", "CMN"),
    blurb="Morocco has two doors. Hold a valid Schengen or US visa and you may enter without applying for "
          "anything, subject to conditions. Otherwise you apply for an e-visa online. Knowing which door is "
          "yours before you book saves an expensive misunderstanding at check-in.",
    requirements=[
        "<strong>Either</strong> an approved Moroccan e-visa, <strong>or</strong> a valid Schengen or US visa meeting the stated conditions.",
        "<strong>Passport valid six months</strong> beyond arrival.",
        "<strong>Return or onward ticket</strong> within the permitted stay.",
        "<strong>Hotel booking</strong> covering the visit.",
    ],
    official="Morocco's official access portal publishes both the e-visa application and the waiver conditions. The qualifying-visa terms are specific about entry type and validity, so read them there.",
    traps=[
        ("Assuming any Schengen visa qualifies",
         "The conditions are specific about visa type and remaining validity. A short-validity or already-spent visa may not qualify."),
        ("Applying through a lookalike site",
         "Several sites mimic the official portal and charge a markup. Start from acces-maroc.ma."),
        ("Arriving one way",
         "Morocco expects a return or onward ticket, and airlines enforce it before you board."),
        ("No confirmed accommodation",
         "Asked for on the form and at the border, particularly for first-time visitors."),
    ],
    steps=[
        ("Check whether the waiver applies to you", "It depends on the type and validity of the visa you hold."),
        ("If not, apply on the official portal", "acces-maroc.ma, with a passport scan and photo."),
        ("Book accommodation for the stay", "Required on the form."),
        ("Sort a return or onward booking", "Checked at the gate."),
        ("Print the approval", "Carry paper as well as your phone."),
    ],
    fees=[("e-Visa", "Around USD 30", "Paid online during the application"),
          ("Visa free entry", "Free", "If you hold a qualifying Schengen or US visa"),
          ("Agent markup", "Avoidable", "The official portal is straightforward")],
    tips=[
        "Marrakech and Fes are both worth it but they are tiring in sequence. Put the coast or the desert between them.",
        "The Sahara trip from Marrakech is two nights, not one. The one-night version is ten hours of driving for a short evening.",
        "Agree taxi fares before getting in, or insist on the meter. This is normal here and not considered rude.",
        "Riads inside the medina are the better stay, but drag your suitcase in daylight the first time. The lanes are genuinely confusing after dark.",
    ],
    faqs=[
        ("Do Indians need a visa for Morocco?",
         "<p>Usually yes, and an e-visa is available online. Holders of a valid Schengen or US visa may enter without applying, subject to conditions published on the official portal.</p>"),
        ("How long does the e-visa take?",
         "<p>Typically a few working days. Apply at least two to three weeks before travel.</p>"),
        ("Does my Schengen visa need to be unused?",
         "<p>The conditions are specific about type and validity. Read them on acces-maroc.ma rather than assuming, because airlines enforce the answer at boarding.</p>"),
        ("Do I need a hotel booking?",
         "<p>Yes. Confirmed accommodation is asked for on the application and at the border.</p>"),
    ]),

# =================================================================== Brazil
dict(
    slug="brazil-visa-for-indians",
    official_src=('e-Visa portal, Government of Brazil', 'https://brazil.vfsevisa.com/'),
    label="Brazil", short="Brazil",
    status="visa_required", status_note="Visa required, applied for online before travel",
    h1="Brazil visa for Indian passport holders",
    title="Brazil Visa for Indians 2026 | e-Visa Cost and Documents",
    desc="Indians need a visa for Brazil, applied for online before travel. What the application asks for, the financial and itinerary evidence that decides it, and the yellow fever rule.",
    route=("DEL", "GRU"),
    blurb="Brazil requires a visa from Indian passport holders, applied for online ahead of travel. There is "
          "no visa on arrival and no waiver, so this is a trip to plan several weeks out rather than book on "
          "impulse.",
    requirements=[
        "<strong>Approved e-visa</strong> before travel. There is no visa on arrival.",
        "<strong>Passport valid six months</strong> beyond arrival, with blank pages.",
        "<strong>Proof of funds</strong>, usually recent bank statements.",
        "<strong>Return flight booking</strong> and accommodation for the stay.",
        "<strong>Yellow fever certificate</strong> for some regions and onward destinations.",
    ],
    official="Brazil's e-visa is issued through its official online service. Apply only through the government-designated portal, and allow several weeks.",
    traps=[
        ("Leaving it late",
         "Processing runs to several weeks in busy periods. This is not a trip to book for next month."),
        ("A photograph or passport scan that fails the spec",
         "The commonest cause of a returned application, and each round trip costs days."),
        ("No yellow fever certificate for onward travel",
         "Several neighbouring countries require it if you have been in Brazil. Check your whole route, not just the entry."),
        ("An itinerary that does not match the stated purpose",
         "Tourist applications with business-shaped itineraries get queried."),
    ],
    steps=[
        ("Start at least six weeks out", "Processing is slow enough that this matters."),
        ("Apply on the official e-visa service", "Not a lookalike site."),
        ("Assemble financial evidence", "Recent statements showing the trip is funded."),
        ("Book a return flight and accommodation", "Both are asked for."),
        ("Check yellow fever for your full route", "Including anywhere you go after Brazil."),
    ],
    fees=[("e-Visa", "Around USD 80", "Plus the service fee, non-refundable if refused"),
          ("Yellow fever certificate", "Varies", "Required for some regions and onward countries"),
          ("Agent markup", "Avoidable", "The official service takes the same application")],
    tips=[
        "Rio and Sao Paulo are an hour apart by air and nothing alike. Rio for the setting, Sao Paulo for the food and the museums.",
        "Iguazu is worth the detour and needs both sides to make sense: the Brazilian side for the panorama, the Argentine side for the walkways.",
        "Distances are continental. Brazil is larger than the contiguous United States, so plan on flying between regions rather than driving.",
        "Learn a few words of Portuguese rather than defaulting to Spanish. It is a different language and the effort is noticed.",
    ],
    faqs=[
        ("Do Indians need a visa for Brazil?",
         "<p>Yes. There is no visa on arrival for Indian passport holders. Apply online through the official e-visa service before you travel.</p>"),
        ("How long does it take?",
         "<p>Several weeks in busy periods. Start at least six weeks before you intend to travel.</p>"),
        ("Do I need a yellow fever certificate?",
         "<p>For some regions of Brazil, and for onward travel to several neighbouring countries. Check your entire route rather than just the arrival.</p>"),
        ("Is the fee refundable if refused?",
         "<p>No. That is the reason to get the photograph, the passport details and the financial evidence right first time.</p>"),
    ]),
]
